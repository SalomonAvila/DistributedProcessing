...
func TestProcessCSVReader(t *testing.T) {
	csvData := `id_del_proceso,nit_entidad,proveedores_invitados,proveedores_unicos_con_respuestas,modalidad_de_contratacion,estado_del_procedimiento
CO1.P1,900123456,10,3,Licitacion Publica,Adjudicado
CO1.P2,900654321,5,1,Seleccion Abreviada,Adjudicado
CO1.P3,900111222,8,0,Minima Cuantia,Desierto
`
...
func TestContractCSVReader(t *testing.T) {
	csvData := `proceso_de_compra,nit_entidad,documento_proveedor,proveedor_adjudicado,valor_del_contrato,codigo_de_categoria_principal,fecha_de_firma
CO1.P1,900123456,800999000,PROV ACME,150000000,80101500,2026-01-15
CO1.P2,900654321,800888111,PROV GLOBEX,50000000,72101500,2026-02-20
`
