...
const file_proto_mapreduce_proto_rawDesc = "" +
	...
	"\rWorkerService\x127\n" +
	"\x04Ping\x12\x16.mapreduce.PingRequest\x1a\x17.mapreduce.PingResponseB5Z3github.com/SalomonAvila/DistributedProcessing/protob\x06proto3"
...
var file_proto_mapreduce_proto_goTypes = []any{
	...
	(*PingResponse)(nil), // 1: mapreduce.PingResponse
}
var file_proto_mapreduce_proto_depIdxs = []int32{
	0, // 0: mapreduce.WorkerService.Ping:input_type -> mapreduce.PingRequest
	1, // 1: mapreduce.WorkerService.Ping:output_type -> mapreduce.PingResponse
